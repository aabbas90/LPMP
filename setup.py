...
setup(
    ...
    ext_modules=[CMakeExtension(name='asymmetric_multiway_cut_py'), CMakeExtension(name='multiway_cut_py')], #CMakeExtension(name='graph_matching_py'), CMakeExtension(name='multigraph_matching_py')],
