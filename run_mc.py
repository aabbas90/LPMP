...
ax3.imshow(edge_labels_2d[0], cmap = 'gray', interpolation='nearest')
ax3.set_title('Row edges, dist=1')
ax4.imshow(edge_labels_2d[1], cmap = 'gray', interpolation='nearest')
ax4.set_title('Col edges, dist=1')
plt.show()